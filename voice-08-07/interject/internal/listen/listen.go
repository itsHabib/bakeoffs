// Package listen turns a stretch of speech into one classification.
//
...
func framed(transcript, spoken []string) string {
	...
	if len(spoken) > 0 {
		out.WriteString("You have already said these aloud. Do not raise them again:\n")
		for _, line := range spoken {
			out.WriteString("  - " + line + "\n")
		}
		out.WriteString("\n")
	}
	out.WriteString("Classify ONLY this, the most recent thing they said:\n  ")
