...
-- Keep mentioned-role validation deterministic even when a role appears often.
_uniqueMentionedRoles :: Protocol -> [Role]
_uniqueMentionedRoles = nub . mentionedRoles
