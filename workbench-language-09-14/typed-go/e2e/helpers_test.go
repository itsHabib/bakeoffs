...
import (
	...
	"github.com/itsHabib/hack-workbench-typed/foundation"
	"github.com/itsHabib/hack-workbench-typed/wb"
)
...
func TestMain(m *testing.M) {
	...
	for _, p := range programs {
		cmd := exec.Command("go", "build", "-o", filepath.Join(dir, p), "github.com/itsHabib/hack-workbench-typed/cmd/"+p)
