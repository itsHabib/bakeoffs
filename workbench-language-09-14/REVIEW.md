...
> The active follow-up is [Terraform + Fleet + Rooms](https://github.com/itsHabib/workbench/tree/main/experiments/terraform-fleet).
...
- [HCL README](hcl/README.md)
- [Purpose-built language README](custom-language/README.md)
  and [review record](custom-language/REVIEW.md)
- [Typed API README](typed-go/README.md)
- [Deployment-manifest use case](deployment-manifest-use-case.md)
- [Terraform + Fleet + Rooms follow-up](https://github.com/itsHabib/workbench/tree/main/experiments/terraform-fleet)
