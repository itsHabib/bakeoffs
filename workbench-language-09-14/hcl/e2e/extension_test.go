...
import (
	...
	"github.com/itsHabib/hack-workbench-hcl/adapter"
	"github.com/itsHabib/hack-workbench-hcl/adapters"
	"github.com/itsHabib/hack-workbench-hcl/internal/apply"
	"github.com/itsHabib/hack-workbench-hcl/internal/evidence"
	"github.com/itsHabib/hack-workbench-hcl/internal/intent"
	"github.com/itsHabib/hack-workbench-hcl/internal/plan"
)
...
func TestEngineNeverImportsBuiltinAdapters(t *testing.T) {
	const builtins = "github.com/itsHabib/hack-workbench-hcl/adapters"
